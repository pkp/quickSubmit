...
{block name="page"}
	...
	<div id="quickSubmitPlugin" class="app__contentPanel">
		...
		<form class="pkp_form" id="quickSubmitForm" method="post" action="{plugin_url path="saveSubmit"}">
			...
			{capture assign="representationsGridUrl"}{url router=PKP\core\PKPApplication::ROUTE_COMPONENT component="grid.articleGalleys.ArticleGalleyGridHandler" op="fetchGrid" submissionId=$submissionId publicationId=$publicationId escape=false}{/capture}
